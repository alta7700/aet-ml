...
|:----------|:----------|:---------|:--------------|------------------:|---------------:|--------------:|-----------------:|------:|------:|--------------------:|------------------:|
| v0011     | noabs     | linear   | GBM(n=50,d=2) |            2.9425 |         1.9975 |        3.7667 |           3.8528 | 0.71  | 0.437 |               0.056 |                18 |
| v0011     | with_abs  | linear   | GBM(n=50,d=2) |            2.9425 |         1.9975 |        3.7667 |           3.8528 | 0.71  | 0.437 |               0.056 |                18 |
...
| version   | variant   | family   | inner_model      |   loso_mae_median |   loso_mae_std |   raw_mae_min |   kalman_mae_min |   rho |    r2 |   loso_neg_r2_share |   loso_n_subjects |
|:----------|:----------|:---------|:-----------------|------------------:|---------------:|--------------:|-----------------:|------:|------:|--------------------:|------------------:|
| v0011     | with_abs  | linear   | SVR(C=100,ε=1.0) |            2.112  |         1.8667 |        3.5172 |           3.5886 | 0.745 | 0.52  |               0.056 |                18 |
| v0011     | noabs     | linear   | SVR(C=100,ε=1.0) |            2.112  |         1.8667 |        3.6416 |           3.7108 | 0.728 | 0.489 |               0.056 |                18 |
...
| version   | variant   | family   | inner_model      |   loso_mae_median |   loso_mae_std |   raw_mae_min |   kalman_mae_min |   rho |    r2 |   loso_neg_r2_share |   loso_n_subjects |
|:----------|:----------|:---------|:-----------------|------------------:|---------------:|--------------:|-----------------:|------:|------:|--------------------:|------------------:|
| v0011     | noabs     | linear   | SVR(C=100,ε=1.0) |            2.2293 |         1.9752 |        3.2626 |           3.3112 | 0.792 | 0.584 |               0.056 |                18 |
| v0011     | with_abs  | linear   | SVR(C=100,ε=1.0) |            2.2293 |         1.9752 |        3.2867 |           3.3515 | 0.791 | 0.574 |               0.056 |                18 |
...
| version   | variant   | family   | inner_model   |   loso_mae_median |   loso_mae_std |   raw_mae_min |   kalman_mae_min |   rho |    r2 |   loso_neg_r2_share |   loso_n_subjects |
|:----------|:----------|:---------|:--------------|------------------:|---------------:|--------------:|-----------------:|------:|------:|--------------------:|------------------:|
| v0011     | noabs     | linear   | Huber(ε=1.1)  |            3.5103 |         2.0107 |        4.0095 |           4.1097 | 0.665 | 0.391 |               0.167 |                18 |
| v0011     | with_abs  | linear   | Huber(ε=1.1)  |            3.5103 |         2.0107 |        4.0142 |           4.1424 | 0.654 | 0.379 |               0.167 |                18 |
...
| version   | variant   | family   | inner_model   |   loso_mae_median |   loso_mae_std |   raw_mae_min |   kalman_mae_min |   rho |    r2 |   loso_neg_r2_share |   loso_n_subjects |
|:----------|:----------|:---------|:--------------|------------------:|---------------:|--------------:|-----------------:|------:|------:|--------------------:|------------------:|
| v0011     | noabs     | linear   | GBM(n=50,d=3) |            3.6161 |         2.0263 |        3.9978 |           4.0737 | 0.736 | 0.444 |               0.333 |                18 |
| v0011     | with_abs  | linear   | GBM(n=50,d=3) |            3.6161 |         2.0263 |        4.1421 |           4.1327 | 0.719 | 0.371 |               0.333 |                18 |
